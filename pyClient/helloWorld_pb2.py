...
_HELLOREQUEST = _descriptor.Descriptor(
  name='helloRequest',
  full_name='helloRPC.helloRequest',
  filename=None,
  file=DESCRIPTOR,
...
_HELLORPC = _descriptor.ServiceDescriptor(
  name='helloRPC',
  full_name='helloRPC.helloRPC',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='sendRequest',
    full_name='helloRPC.helloRPC.sendRequest',
    index=0,
...
DESCRIPTOR.services_by_name['helloRPC'] = _HELLORPC
